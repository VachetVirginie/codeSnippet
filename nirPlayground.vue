<template>
  <div class="playground-container">
    ...
    <div class="validation-info">
      ...
      <div>
        <strong>Format attendu:</strong> 15 chiffres (13 + 2 chiffres de contrôle)
      </div>
      <div>
        <strong>Exemple valide:</strong> 1 89 05 75 108 157 42
      </div>
    </div>
  </div>
</template>
